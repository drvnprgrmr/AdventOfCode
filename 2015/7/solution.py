...
wire_values = defaultdict(lambda: -1)
input_wires = set()  # wires that have no input from any wires
output_wires = set()  # wires that don't give output signals to a wire
